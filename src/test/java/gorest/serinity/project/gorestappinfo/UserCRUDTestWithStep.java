package gorest.serinity.project.gorestappinfo;

import gorest.serinity.project.testbase.TestBase;
import gorest.serinity.project.utils.TestUtils;
...
public class UserCRUDTestWithStep extends TestBase {
    ...
    @Test
    public void test002() {
        HashMap<String, Object> productMap = userSteps.getProductInfoAddedByID(name);
